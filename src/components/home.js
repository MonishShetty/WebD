...
export default function home() {
  return (
    <div class="formmain" style={{
      backgroundImage: "url('https://images.pexels.com/photos/388415/pexels-photo-388415.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')", backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: "no-repeat"
    }}>
...
<h1 className="why">Why Krushi Comrade?</h1>
      ...
      <div className="newpages">
          <a href="#" class="buttonClass">
            <Link to="/buy" style={{textDecoration:'none'}}><div className="bpf"> Buy products</div></Link>
          </a>

          <a href="#" class="buttonClass"><Link to="/sell" style={{textDecoration:'none'}}><div className="bpf"> Sell your products</div></Link></a>
